      ...
      describe '#initialze' do
        context 'when config is nil' do
          ...
          it 'throws an exception' do
            expect { Factory.new(config) }.to raise_error 'Missing config'
          end
        end
        ...
        context 'when config is missing the :buildpacks key' do
          ...
          it 'throws an exception' do
            expect { Factory.new(config) }.to raise_error 'Missing :buildpacks config'
          end
        end
        ...
        context 'when config is missing the :fog_connection key' do
          ...
          it 'throws an exception' do
            expect { Factory.new(config) }.to raise_error 'Missing :fog_connection config'
          end
        end
      end
